...
var famous_people = [{
  Name:"Dave Chappelle",Age:43,Profession:"Comedian"},{
  Name:"Michael Jordan",Age:53,Profession:"Golfer"},{
  Name:"Rihanna",Age:25,Profession:"Singer"}
    ];
...
var songs = [{artist:"Farruko",song:"6am"},{artist:"J Balvin",song:"Ay vamos"},{artist:"Enrique Iglesias",song:"bailando"}];

// Create an array of functions. Define any functions you want, they can 
// be anything! But make sure the syntax is correct :D
var defunct = [function(){ return a*b; }, 
function(){ console.log("lose yourself");
}];
...
var short_cuts = new Array(2);

short_cuts["command O"] = "Opens File";
short_cuts["command C"] = "Copy File";
short_cuts["command R"] = "Go to";
